...
### Changed
- Moved onto the newer Espressif toolchain (ESP-IDF v6.1). Building the project now needs that version installed instead of v6.0.3. No behaviour change for users.
